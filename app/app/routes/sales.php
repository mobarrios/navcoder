<?php
	//Ventas
		...
		Route::group(array('before'=>'validation:7-add'),function()
		{
			...
			Route::post('additem_sancus_sales', 'SalesController@postAdditemSancus');

			Route::get('process_sales_sancus', 	   		array('as'=>'sales_process_sancus', 'uses'	=>'SalesController@getProcessSancus'));
